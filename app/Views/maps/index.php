...
<?= $this->section('script') ?>
    ...
    <script>
        ...
        var map = L.map('maps').setView({ lat : -5.398936259455986, lon : 105.26764814527598 }, 11);
        ...
        function onEachFeature(feature, layer){
            ...
            layer.bindPopup("<h4>Jumlah Proyeksi Penduduk</h4><br>"+feature.properties.NAMOBJ+" : "+feature.properties.nilai +"(000) ribu jiwa");
            layer.on({
        ...
        this._div.innerHTML = '<h4><?= $masterData->nama ?></h4>'+ (props ?
            '<b>' + props.NAMOBJ+ '</b><br/>'+ props.nilai+ ' (000) ribu jiwa':
